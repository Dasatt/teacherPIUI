      ...
      function ($stateProvider,   $urlRouterProvider) {
          ...
          $stateProvider              
              ...
              .state('app.student.attendance', {
                  url: '/attendance',
                  templateUrl: 'tpl/student/attendance.html',
                  resolve: {
                    deps: ['uiLoad',
                      function( uiLoad ){
              ...
              .state('app.cards', {
                  ...
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad){
                          return uiLoad.load('js/controllers/cards.js');
                      }]
                  }
              })
              .state('app.cards.logs', {
                  url: '/logs',
                  templateUrl: 'tpl/card_logs.html',

              })
              .state('app.cards.load-cards', {
                  url: '/load-cards',
                  templateUrl: 'tpl/load_cards.html',

              })
              .state('app.cards.generate', {
                  url: '/generate-cards',
                  templateUrl: 'tpl/generate_cards.html'
              })
              ...
              .state('app.methods', {
                  ...
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad){
                          return uiLoad.load('js/controllers/methods.js');
                      }]
                  }
              })
              .state('app.methods.manage', {
                  url: '/manage',
                  templateUrl: 'tpl/manage_methods.html',
